...
class searchmedecinn extends StatefulWidget {

  const searchmedecinn({super.key});

  @override
  State<searchmedecinn> createState() => _searchmedecinnState();
}


class _searchmedecinnState extends State<searchmedecinn>
